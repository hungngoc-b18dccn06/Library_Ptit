    ...
    public function forgotpass(){
       if(isset($_POST['submit'])){
        ...
        if (empty($username)){
            ...
            $this->error = 'Username này không đã tồn tại';
        }
                if (empty($this->error)){
                    $_SESSION['success'] = 'Lấy lại mật khẩu thành công vui lòng check email để nhận mật khẩu mới';
                } else {
       ...
       $this->content = $this->render('views/users/forgotpass.php');
        require_once 'views/layouts/main_login.php';
    }
}